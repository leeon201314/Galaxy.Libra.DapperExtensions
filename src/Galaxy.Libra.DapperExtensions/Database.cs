...
namespace Galaxy.Libra.DapperExtensions
{
    public interface IDatabase : IDisposable
    {
        ...
        bool DeleteWhere<T>(object predicate, IDbTransaction transaction, int? commandTimeout = null) where T : class;
        bool DeleteWhere<T>(object predicate, int? commandTimeout = null) where T : class;
    ...
    public class Database : IDatabase
    {
        ...
        public bool DeleteWhere<T>(object predicate, IDbTransaction transaction, int? commandTimeout) where T : class
        {
            return _dapper.Delete<T>(Connection, predicate, transaction, commandTimeout);
        }

        public bool DeleteWhere<T>(object predicate, int? commandTimeout) where T : class
        {
